// mbti-data.js - MBTI测试数据模块
// 将JSON数据转换为JavaScript模块以避免CORS问题
...
window.MBTI_DATA = {
  ...
  ui: {
    ...
    "notifications": {
      "dataLoading": "测试数据正在加载，请稍候再试",
      "testStarted": "测试已开始，请根据您的真实想法作答",
      "testCompleted": "测试完成！您的MBTI类型已分析出来",
      "localMode": "当前为本地文件模式，认证功能受限",
      "localLogin": "本地文件模式下无法进行真实登录，请部署到服务器环境",
      "localRegister": "本地文件模式下无法进行真实注册，请部署到服务器环境",
      "dataLoadFailed": "数据加载出现问题，已使用备用数据",
      "shareSuccess": "分享成功！",
      "resultSaved": "结果已保存到本地文件！",
      "clipboardCopy": "已复制到剪贴板！",
      "clipboardFail": "复制失败，请手动复制",
      "confirmExit": "确定要退出测试吗？当前进度将会丢失。"
    },
    "labels": {
      "analyzing": "正在分析您的答案...",
      "pleaseWait": "请稍候，我们正在计算您的MBTI人格类型",
      "personalityDescription": "性格描述",
      "testDuration": "测试用时",
      "testDate": "测试日期",
      "dimensionAnalysis": "维度分析",
      "mainCharacteristics": "主要特征",
      "careerDirections": "适合的职业方向",
      "suitableCareers": "适合的职业方向",
      "minutes": "分钟",
      "questionCategory": {
        "EI": "外向/内向",
        "SN": "感觉/直觉",
      ...
      "dimensionPairs": [
        { "name": "外向 vs 内向", "e": "E", "i": "I" },
        { "name": "感觉 vs 直觉", "e": "S", "i": "N" },
        { "name": "思考 vs 情感", "e": "T", "i": "F" },
        { "name": "判断 vs 知觉", "e": "J", "i": "P" }
      ],
      "resultShare": "我的MBTI人格类型是 {type} - {title}！快来测试你的人格类型吧！",
      "resultFileTitle": "MBTI人格测试结果",
      "resultFileContent": "MBTI人格测试结果\n================\n\n测试类型: {type}\n人格类型: {title}\n测试时间: {testDate}\n\n{description}\n\n测试链接: {url}"
    },
    "typeLabels": {
      "E": "外向/内向", "I": "外向/内向",
      "S": "感觉/直觉", "N": "感觉/直觉",
  ...
  logging: {
    "pageLoaded": "🧠 MBTI测试页面加载完成",
    "dataLoading": "📚 开始加载MBTI测试数据和文案",
    "dataLoadSuccess": "✅ MBTI数据和文案加载成功",
    "dataLoadFail": "❌ MBTI数据加载失败",
    "backupData": "⚠️ 使用备用MBTI数据",
    "authInit": "🔧 开始初始化MBTI页面认证系统",
    "localFileDetected": "⚠️ 检测到本地文件环境，使用简化认证模式",
    "authManagerNotFound": "❌ authManager 未找到",
    "configManagerNotFound": "❌ configManager 未找到",
    "configReady": "✅ 配置管理器已就绪，初始化认证系统",
    "configTimeout": "⚠️ 配置管理器等待超时，切换到本地模式",
    "configWaiting": "⏳ 等待配置管理器准备就绪... ({current}/{max})",
    "authInitFail": "❌ 认证系统初始化失败",
    "localAuthInit": "🏠 初始化本地文件认证系统",
    "localAuthComplete": "✅ 本地认证系统初始化完成",
    "modalEventsSetup": "🎛️ 本地模态框事件监听器已设置",
    "loginModalClosed": "🔒 登录模态框已关闭",
    "loginModalClosedOutside": "🔒 登录模态框已关闭（点击外部）",
    "registerModalClosed": "📝 注册模态框已关闭",
    "localLoginAttempt": "ℹ️ 本地模式登录尝试",
    "localRegisterAttempt": "ℹ️ 本地模式注册尝试",
    "buttonInitialized": "🔘 开始测试按钮初始化完成",
    "testStart": "🚀 开始MBTI测试",
    "dataNotLoaded": "⚠️ 数据尚未加载完成，无法开始测试",
    "testComplete": "✅ 测试完成",
    "testReset": "🔄 重置测试",
    "resultSaved": "✅ 结果已保存到本地存储",
    "resultSaveFail": "❌ 保存结果失败",
    "foundPreviousResult": "📊 发现 {days} 天前的测试结果: {type}",
    "navigationInitialized": "🧭 导航按钮初始化完成",
    "navigationUpdated": "🔄 导航按钮状态已更新",
    "musicAutoplayBlocked": "自动播放被阻止:",
    "scriptInitComplete": "🧠 MBTI测试脚本初始化完成"
  }
};
